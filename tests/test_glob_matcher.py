...
class TestGlobMatcher(unittest.TestCase):
    def test_ruff_0_15_12_spec_basename_patterns(self) -> None:
    ...
    def test_ruff_0_15_12_spec_bare_exclude_matches_parent_segments(self) -> None:
        matcher = GlobPatternSet.compile(
            (".mypy_cache", "skip.py"),
    ...
    def test_ruff_0_15_12_spec_slash_patterns_are_project_relative(self) -> None:
        matcher = GlobPatternSet.compile(
    ...
    def test_ruff_0_15_12_spec_slash_excludes_match_descendants(self) -> None:
        matcher = GlobPatternSet.compile(
            ("src/generated",),
            include_patterns=False,
            match_parent_segments_for_bare=True,
    ...
    def test_ruff_0_15_12_spec_double_star_matches_zero_or_more_segments(self) -> None:
        matcher = GlobPatternSet.compile(
            ("src/**/test*.py",),
            include_patterns=True,
            match_parent_segments_for_bare=False,
