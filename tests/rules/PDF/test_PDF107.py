...
def test_check_fix_line_numbers_and_fix_false_findings_agree() -> None:
    ...
    findings = rule_helpers.rule_findings(PDF107MultilineOpeningQuotesSeparateLine, context)
    fixed = rule_helpers.rule_fix_result(PDF107MultilineOpeningQuotesSeparateLine, context)
    ...
    assert rule_helpers.rule_findings(PDF107MultilineOpeningQuotesSeparateLine, fixed_context) == ()
