...
def test_reports_empty_yield_section_and_sphinx_field() -> None:
    source = 'def section():\n    """Do work.\n\n    Yields:\n    """\n\n\ndef field():\n    """Do work.\n\n    :yields: Value.\n    """\n'
    result = format_source(source, settings=CheckSettings(select=("PDF505",), docstring_convention=DocstringConvention.NONE))

    assert_pdf505_lines('def section():\n    """Do work.\n\n    Yields:\n    """\n', ((4,),))
    assert_pdf505_lines(source, ((11,),), settings=CheckSettings(select=("PDF505",), docstring_convention=DocstringConvention.NONE))
...
def test_reports_multiple_yield_documentation_targets() -> None:
    ...
    assert_pdf505_lines(source, ((4,), (7,), (10,)))


def test_concatenated_docstring_yield_field_uses_physical_line_fallback() -> None:
    source = 'def function():\n    ("Do work.\\n\\n"\n     ":yields: Value.")\n'

    assert_pdf505_lines(source, ((2, 3),), settings=CheckSettings(select=("PDF505",), docstring_convention=DocstringConvention.NONE))
...
def test_sphinx_field_parsing_setting_controls_sphinx_yield_documentation() -> None:
    ...
    assert_pdf505_lines(source, (), settings=CheckSettings(select=("PDF505",), docstring_convention=DocstringConvention.NONE, docstring_parse_sphinx_fields=False))
