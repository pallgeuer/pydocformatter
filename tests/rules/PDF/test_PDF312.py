...
import pydocformatter.rules.definitions.PDF.PDF312_entry_description_too_generic as PDF312_definition
...
def test_exact_description_matching_normalizes_only_outer_style(description: str) -> None:
    ...
    assert PDF312_definition._matches_exact_description(description, _SEQUENCES)
...
def test_exact_description_matching_rejects_internal_or_non_ascii_variants(description: str) -> None:
    ...
    assert not PDF312_definition._matches_exact_description(description, _SEQUENCES)
...
def test_exact_description_fragment_safety_accepts_ascii_space_and_tab(text: str) -> None:
    ...
    assert PDF312_definition._exact_description_fragment_is_safe(text)
...
def test_exact_description_fragment_safety_rejects_controls_and_non_ascii_text(text: str) -> None:
    ...
    assert not PDF312_definition._exact_description_fragment_is_safe(text)
...
def test_exact_named_description_uses_existing_name_token_style(name: str, description: str) -> None:
    ...
    assert PDF312_definition._matches_exact_named_description(description, name, _NAMED_TEMPLATES)
...
def test_exact_named_description_does_not_add_boundary_underscores(description: str) -> None:
    ...
    assert not PDF312_definition._matches_exact_named_description(description, "run", _NAMED_TEMPLATES)
...
def test_exact_named_description_requires_complete_qualified_name() -> None:
    ...
    assert not PDF312_definition._matches_exact_named_description("The ValueError value.", "errors.ValueError", _NAMED_TEMPLATES)
...
def test_exact_named_description_rejects_empty_or_non_ascii_inputs(name: str, description: str) -> None:
    ...
    assert not PDF312_definition._matches_exact_named_description(description, name, _NAMED_TEMPLATES)
