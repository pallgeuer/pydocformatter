...
def test_check_fix_line_numbers_and_fix_false_findings_agree() -> None:
    ...
    findings = PDF106MultilineOpeningQuotesSameLine.check(context)
    fixed = PDF106MultilineOpeningQuotesSameLine.fix(context)
    ...
    assert PDF106MultilineOpeningQuotesSameLine.check(fixed_context) == ()
