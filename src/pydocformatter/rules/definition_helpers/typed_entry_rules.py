...
_TARGET_COLLECTORS: dict[typed_models.TypedDocumentationSubject, _TargetCollector] = {
    typed_models.TypedDocumentationSubject.PARAMETER: typed_documentation.parameter_targets,
    typed_models.TypedDocumentationSubject.RETURN: typed_documentation.return_targets,
    typed_models.TypedDocumentationSubject.YIELD: typed_documentation.yield_targets,
    typed_models.TypedDocumentationSubject.CLASS_ATTRIBUTE: typed_documentation.class_attribute_targets,
    typed_models.TypedDocumentationSubject.MODULE_ATTRIBUTE: typed_documentation.module_attribute_targets,
}
_REQUIRED_TYPE_POLICIES: dict[typed_models.TypedDocumentationSubject, _RequiredTypePolicy] = {}
...
def missing_description_violations(context: RuleContext, *, meta: RuleMetadata, subject: typed_models.TypedDocumentationSubject, label: str) -> tuple[rule_violations.RuleViolation, ...]:
...
def required_type_violations(context: RuleContext, *, meta: RuleMetadata, subject: typed_models.TypedDocumentationSubject, label: str) -> tuple[rule_violations.RuleViolation, ...]:
...
_REQUIRED_TYPE_POLICIES.update({typed_models.TypedDocumentationSubject.CLASS_ATTRIBUTE: _class_attribute_required_type_violations})


def forbidden_type_violations(context: RuleContext, *, meta: RuleMetadata, subject: typed_models.TypedDocumentationSubject, label: str) -> tuple[rule_violations.RuleViolation, ...]:
...
def mismatch_violations(context: RuleContext, *, meta: RuleMetadata, subject: typed_models.TypedDocumentationSubject, label: str) -> tuple[rule_violations.RuleViolation, ...]:
