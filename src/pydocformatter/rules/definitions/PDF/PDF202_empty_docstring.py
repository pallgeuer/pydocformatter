...
class PDF202EmptyDocstring(RuleBase):
    ...
    def violations(cls, context: RuleContext) -> tuple[rule_violations.RuleViolation, ...]:
        ...
        return tuple(rule_violations.diagnostic(cls.meta, docstring_source.docstring_physical_line_numbers(docstring)) for docstring in data.docstrings if not docstring.value.strip())
