"""PDF504 missing-yield-documentation rule."""
...
class PDF504MissingYieldDocumentation(RuleBase):
    """Rule implementation for PDF504.
    ...
    def violations(cls, context: RuleContext) -> tuple[rule_violations.RuleViolation, ...]:
        """Return violations for undocumented meaningful yielded values.
        ...
        for definition, docstring, facts in value_documentation.documented_function_facts(context):
            ...
            if (
                ...
                continue
            violations.append(rule_violations.diagnostic(cls.meta, facts.meaningful_yields[0].line_numbers, suppression_line_numbers=(docstring_source.docstring_physical_line_numbers(docstring),)))
