"""PDF209 blank-line-before-class-docstring rule."""
...
class PDF209BlankLineBeforeClassDocstring(RuleBase):
    """Rule implementation for PDF209.
    ...
    meta = RuleMetadata(
        code=RuleCode("PDF209"),
        name="blank-line-before-class-docstring",
        message="Class docstring should have one blank line before it",
        ...
        incompatible_with=(RuleCode("PDF208"),),
    ...
    def violations(cls, context: RuleContext) -> tuple[rule_violations.RuleViolation, ...]:
        """Return violations for missing or excess blank lines before class docstrings.
        ...
        changes = docstring_statement_spacing.planned_changes(
            context, owner_kind=PDF_definition.DefinitionKind.CLASS, position=docstring_statement_spacing.DocstringStatementSpacingPosition.BEFORE, desired_blank_lines=1
        )
