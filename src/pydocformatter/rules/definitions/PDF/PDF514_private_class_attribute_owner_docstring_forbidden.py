"""PDF514 private-class-attribute-owner-docstring-forbidden rule."""
...
class PDF514PrivateClassAttributeOwnerDocstringForbidden(RuleBase):
    ...
    meta = RuleMetadata(
        ...
        name="private-class-attribute-owner-docstring-forbidden",
        ...
        incompatible_with=(RuleCode("PDF522"),),
