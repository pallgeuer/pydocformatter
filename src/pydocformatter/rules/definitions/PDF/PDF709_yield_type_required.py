...
class PDF709YieldTypeRequired(RuleBase):
    ...
    meta = typed_entry_rules.metadata("PDF709", "yield-type-required", "Function yield docstring entry is missing a type", exact_opt_in=True, incompatible_with=("PDF710",))
