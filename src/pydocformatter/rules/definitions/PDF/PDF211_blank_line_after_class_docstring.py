...
class PDF211BlankLineAfterClassDocstring(RuleBase):
    """Rule implementation for PDF211.
    ...
    meta = RuleMetadata(
        ...
        stable_since="1.0.0",
        setting_effects=(),
        incompatible_with=(RuleCode("PDF210"),),
        check_kind=RuleCheckKind.STANDARD,
    )

    @classmethod
    def violations(cls, context: RuleContext) -> tuple[rule_violations.RuleViolation, ...]:
        """Return violations for missing or excess blank lines after class docstrings.
