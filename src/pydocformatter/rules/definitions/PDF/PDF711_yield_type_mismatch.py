"""PDF711 yield-type-mismatch rule."""
...
class PDF711YieldTypeMismatch(RuleBase):
    """Rule implementation for PDF711.
    ...
    def violations(cls, context: RuleContext) -> tuple[rule_violations.RuleViolation, ...]:
        """Return violations for yield docstring types that mismatch annotations.
        ...
        """
        return typed_entry_rules.mismatch_violations(context, meta=cls.meta, subject=typed_entry_rules.TypedDocumentationSubject.YIELD, label="Function yield")
