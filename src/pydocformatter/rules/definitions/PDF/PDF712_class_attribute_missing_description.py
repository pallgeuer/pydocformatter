...
class PDF712ClassAttributeMissingDescription(RuleBase):
    ...
    meta = typed_entry_rules.metadata("PDF712", "class-attribute-missing-description", "Class attribute docstring entry is missing a description", convention_opt_in=False)
    ...
    def violations(cls, context: RuleContext) -> tuple[rule_violations.RuleViolation, ...]:
        ...
        """
        return typed_entry_rules.missing_description_violations(context, meta=cls.meta, subject=typed_models.TypedDocumentationSubject.CLASS_ATTRIBUTE, label="Class attribute")
