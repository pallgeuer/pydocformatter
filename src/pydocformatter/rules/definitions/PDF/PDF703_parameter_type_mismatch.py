"""PDF703 parameter-type-mismatch rule."""
...
class PDF703ParameterTypeMismatch(RuleBase):
    """Rule implementation for PDF703.

    Attributes:
        meta (RuleMetadata): Static metadata used for registration, diagnostics, and rule selection.
    """

    meta = typed_entry_rules.metadata("PDF703", "parameter-type-mismatch", "Function parameter docstring type does not match the annotation", convention_opt_in=False, incompatible_with=("PDF702",))

    @classmethod
    def violations(cls, context: RuleContext) -> tuple[rule_violations.RuleViolation, ...]:
        """Return violations for parameter docstring types that mismatch annotations.
