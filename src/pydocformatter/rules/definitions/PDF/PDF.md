...
| `PDF4xx` | Convention structure                      | Section names, headers, underlines, content, order, entry syntax, entry indentation, spacing, and punctuation.                                                           |
...
| `PDF7xx` | Entry completeness and type consistency   | Parsed entry descriptions, reStructuredText value/type pairing, type presence policies, and conservative annotation/type mismatch checks.                                |
