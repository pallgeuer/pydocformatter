...
| `PDF4xx` | Convention structure                      | Section names, headers, underlines, content, order, entry syntax, entry indentation, spacing, punctuation, and conservative type spelling.                                                              |
