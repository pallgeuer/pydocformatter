...
class PDF718ModuleAttributeTypeForbidden(RuleBase):
    ...
    meta = typed_entry_rules.metadata(
        "PDF718", "module-attribute-type-forbidden", "Module attribute docstring entry should not include a type", convention_opt_in=True, incompatible_with=("PDF717", "PDF719")
    )
    ...
    def violations(cls, context: RuleContext) -> tuple[rule_violations.RuleViolation, ...]:
        ...
        """
        return typed_entry_rules.forbidden_type_violations(context, meta=cls.meta, subject=typed_models.TypedDocumentationSubject.MODULE_ATTRIBUTE, label="Module attribute")
