...
## Options
- `docstring-optional-function-decorators`: Exact function decorator names that make PDF615 allow a private `__init__` method to omit a docstring.
- `docstring-forbidden-function-decorators`: Exact function decorator names that make PDF615 allow a private `__init__` method to omit a docstring because PDF616 reports docstrings on those definitions instead.
