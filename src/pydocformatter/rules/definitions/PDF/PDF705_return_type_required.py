...
class PDF705ReturnTypeRequired(RuleBase):
    ...
    def violations(cls, context: RuleContext) -> tuple[rule_violations.RuleViolation, ...]:
        ...
        """
        return typed_entry_rules.required_type_violations(context, meta=cls.meta, subject=typed_entry_rules.TypedDocumentationSubject.RETURN, label="Function return")
