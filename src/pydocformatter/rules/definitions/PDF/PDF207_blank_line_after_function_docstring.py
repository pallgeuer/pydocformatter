"""PDF207 blank-line-after-function-docstring rule."""
...
class PDF207BlankLineAfterFunctionDocstring(RuleBase):
    """Rule implementation for PDF207.
    ...
    meta = RuleMetadata(
        code=RuleCode("PDF207"),
        name="blank-line-after-function-docstring",
        message="Function docstring should have one blank line after it",
        ...
        incompatible_with=(RuleCode("PDF206"),),
    ...
    def violations(cls, context: RuleContext) -> tuple[rule_violations.RuleViolation, ...]:
        """Return violations for missing or excess blank lines after function docstrings.
        ...
        changes = docstring_statement_spacing.planned_changes(
            context, owner_kind=PDF_definition.DefinitionKind.FUNCTION, position=docstring_statement_spacing.DocstringStatementSpacingPosition.AFTER, desired_blank_lines=1
        )
