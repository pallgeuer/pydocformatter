...
class PDF110DocstringShouldBeOneLine(RuleBase):
    meta = RuleMetadata(
    ...
    def check(cls, context: RuleContext) -> tuple[RuleFinding, ...]:
        """Return findings for summary-only docstrings that should be collapsed."""
    ...
    def fix(cls, context: RuleContext) -> RuleFixResult:
        """Collapse safe one-summary-line docstrings that fit on one source line."""
