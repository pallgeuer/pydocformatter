...
PDF105 moves the closing quotes without trimming spaces or tabs from the final content line. That whitespace belongs to whitespace-specific rules such as `PDF006`.
...
## Example
The canonical PDF105 fix moves same-line closing quotes onto their own line:
...
PDF105 preserves final content trailing whitespace so whitespace-specific rules can handle it:
