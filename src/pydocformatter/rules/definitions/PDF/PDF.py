...
class _DocstringParser:
    ...
    def _reflow_line_from_text_span(self, line_index: int, start_column: int, end_column: int) -> DocstringTextFragment | None:
        ...
        full_start_offset = docstring_source.value_offset_for_text_column(line, start_column)
        full_end_offset = docstring_source.value_offset_for_text_column(line, end_column)
        ...
        if start_column > end_column:
            return None
        start_offset = docstring_source.value_offset_for_text_column(line, start_column)
        end_offset = docstring_source.value_offset_for_text_column(line, end_column)
