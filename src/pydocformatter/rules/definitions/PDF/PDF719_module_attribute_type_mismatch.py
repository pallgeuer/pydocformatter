...
class PDF719ModuleAttributeTypeMismatch(RuleBase):
    ...
    meta = typed_entry_rules.metadata(
        "PDF719", "module-attribute-type-mismatch", "Module attribute docstring type does not match the annotation", convention_opt_in=False, incompatible_with=("PDF718",)
    )
    ...
    def violations(cls, context: RuleContext) -> tuple[rule_violations.RuleViolation, ...]:
        ...
        """
        return typed_entry_rules.mismatch_violations(context, meta=cls.meta, subject=typed_models.TypedDocumentationSubject.MODULE_ATTRIBUTE, label="Module attribute")
