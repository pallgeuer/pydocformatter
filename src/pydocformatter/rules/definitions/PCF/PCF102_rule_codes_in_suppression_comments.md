...
Rule is incompatible with `PCF103`.
...
```pydocfmt-example
[input]
# pydocfmt: ignore[PDF101, docstring-reflow, PCF000]
value = 1
...
[output=unchanged]
[findings]
PCF102: Line 1: Suppression comment should use rule names instead of codes
PCF102: Line 3: Suppression comment should use rule names instead of codes
PCF102: Line 5: Suppression comment should use rule names instead of codes
```
